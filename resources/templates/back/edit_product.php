<?php 
	...
	if(isset($_GET['id']))
	{
		...
		while($row = fetch_array($query))
		{
			...
			$product_image = dislay_image($product_image);
		}
...
<div class="form-group">
	...
	<div class="form-group">
      ...
      <textarea name="short_desc" id="" cols="30" rows="1" class="form-control" value=""><?php echo $short_desc; ?></textarea>
...
<!-- Product Tags -->
    ...
    <div class="form-group">
		...
		<br>
		<br>
		<img width="320" height="150" src="../../resources/<?php echo $product_image; ?>" >
    </div>
